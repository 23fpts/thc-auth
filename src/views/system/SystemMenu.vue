<template>
  <div>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <el-form-item label="是否禁用" prop="status">
              <el-select v-model="menuQueryform.status" placeholder="请选择组织状态">
          ...
          <el-col :span="6" :offset="6">
            <el-form-item>
              <el-button type="primary" size="small" @click="submitQueryForm()" icon="el-icon-search">
                查询</el-button>
              <el-button type="primary" size="small" plain @click="resetQueryForm('menuQueryform')" icon="el-icon-refresh">
                重置</el-button>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    <el-card>
      ...
      <el-table :data="tableData" row-key="id" border default-expand-all stripe style="width: 100%;margin-bottom: 20px;">
        ...
        <el-table-column prop="status" label="是否禁用" width="" align="center" :formatter="statusFormat" />
        ...
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="上级菜单" prop="menuPid">
              <el-tree-select :elTreeProps="elTreeProps" :elTreeData="tableData" :defaultSelectedId="dialogForm.menuPid" :disabled="elTreeDisabled" @handleTreeSelected="handleTreeSelected($event)" @validateSelectTree="validateSelectTree" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
...
<script>
import { getMenuTree, updateMenu, addMenu, deleteMenu } from '@/api/system'
...
export default {
  ...
  methods: {
    submitQueryForm() {
      getMenuTree({
        name: this.menuQueryform.name,
        status: this.menuQueryform.status
      }).then(res => {
        this.setData(res)
      })
    },
