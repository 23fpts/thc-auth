        ...
        <el-row :gutter="20">
          ...
          <el-col :span="6" :offset="6">
            <el-form-item>
              ...
              <el-button type="primary" plain @click="resetQueryForm('orgQueryform')" icon="el-icon-refresh">重置</el-button>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
        ...
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="上级组织" prop="orgPid">
              <el-tree-select :elTreeProps="elTreeProps" :elTreeData="tableData" :defaultSelectedId="dialogForm.orgPid" :disabled="elTreeDisabled" @handleTreeSelected="handleTreeSelected($event)" @validateSelectTree="validateSelectTree" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
